...
pushd customfeeds
mkdir temp
git clone --depth=1 https://github.com/immortalwrt/packages -b openwrt-21.02 temp/packages
git clone --depth=1 https://github.com/immortalwrt/luci -b openwrt-21.02 temp/luci
...
# Add luci-app-netdata 中文版拉取在lean-openwrt文件
